    ...
    if check:
        if filetype in ['png', 'jpg', 'jpeg']:
            with open(filepath, 'rb') as f:
                file_data = f.read()
                # Determine the subtype using Pillow
                try:
                    with Image.open(filepath) as img:
                        subtype = img.format.lower()  # e.g., 'jpeg'
...
def settings():
    ...
    root1 = Toplevel()
    root1.title('Setting')
    root1.geometry('630x340+350+90')
    root1.config(bg='gainsboro')

    Label(root1, text='Credential Settings', image=logoImage, compound=LEFT,
          font=('goudy old style', 40, 'bold'), fg='white', bg='gray20').grid(padx=60)

    fromLabelFrame = LabelFrame(root1, text='From (Email Address)', font=('times new roman', 16, 'bold'),
                                bd=5, fg='black', bg='gainsboro')
    ...
    passwordLabelFrame = LabelFrame(root1, text='Password', font=('times new roman', 16, 'bold'),
                                    bd=5, fg='black', bg='gainsboro')
    ...
    Button(root1, text='SAVE', font=('times new roman', 18, 'bold'), cursor='hand2',
           bg='gold2', fg='black', command=save).place(x=210, y=280)
    Button(root1, text='CLEAR', font=('times new roman', 18, 'bold'), cursor='hand2',
           bg='gold2', fg='black', command=clear1).place(x=340, y=280)
...
root=Tk()
root.title('Custom email sender app')
...
chooseFrame=Frame(root,bg='gainsboro')
...
singleRadioButton=Radiobutton(chooseFrame,text='Single',font=('times new roman',25,'bold')
                              ,variable=choice,value='single',bg='gainsboro',activebackground='gainsboro'
...
multipleRadioButton=Radiobutton(chooseFrame,text='Multiple',font=('times new roman',25,'bold')
                              ,variable=choice,value='multiple',bg='gainsboro', activebackground='gainsboro'
                                ,command=button_check)
...
toLabelFrame=LabelFrame(root,text='To (Email Address)',font=('times new roman',16,'bold'),bd=5,fg='black',bg='gainsboro')
...
browseButton=Button(toLabelFrame,text='  Browse',image=browseImage,compound=LEFT,font=('arial',12,'bold'),
       cursor='hand2',bd=0,bg='gainsboro',state=DISABLED,command=browse)

browseButton.grid(row=0,column=1,padx=20)

subjectLabelFrame=LabelFrame(root,text='Subject',font=('times new roman',16,'bold'),bd=5,fg='black',bg='gainsboro')
...
emailLabelFrame=LabelFrame(root,text='Compose Email',font=('times new roman',16,'bold'),bd=5,fg='black',bg='gainsboro')
...
Button(emailLabelFrame,text='  Speak',image=micImage,compound=LEFT,font=('arial',12,'bold'),
       cursor='hand2',bd=0,bg='gainsboro',activebackground='gainsboro',command=speak).grid(row=0,column=0)
...
Button(emailLabelFrame,text=' Attachment',image=attachImage,compound=LEFT,font=('arial',12,'bold'),
       cursor='hand2',bd=0,bg='gainsboro',activebackground='gainsboro',command=attachment).grid(row=0,column=1)
...
Button(root,image=sendImage,bd=0,bg='gainsboro',cursor='hand2',activebackground='gainsboro',command=send_email).place(x=490,y=540)

clearImage=PhotoImage(file='clear.png')
Button(root,image=clearImage,bd=0,bg='gainsboro',cursor='hand2',activebackground='gainsboro',command=clear).place(x=590,y=550)

exitImage=PhotoImage(file='exit.png')
Button(root,image=exitImage,bd=0,bg='gainsboro',cursor='hand2',activebackground='gainsboro',command=iexit).place(x=690,y=550)

totalLabel=Label(root,font=('times new roman',18,'bold'),bg='gainsboro',fg='black')
totalLabel.place(x=10,y=560)

sentLabel=Label(root,font=('times new roman',18,'bold'),bg='gainsboro',fg='black')
sentLabel.place(x=100,y=560)

leftLabel=Label(root,font=('times new roman',18,'bold'),bg='gainsboro',fg='black')
leftLabel.place(x=190,y=560)

failedLabel=Label(root,font=('times new roman',18,'bold'),bg='gainsboro',fg='black')
